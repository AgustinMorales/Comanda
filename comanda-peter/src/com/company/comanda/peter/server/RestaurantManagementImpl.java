...
public class RestaurantManagementImpl implements RestaurantManager {
    ...
    private static final Logger log = LoggerFactory.getLogger(RestaurantManagementImpl.class);
    ...
    @Override
    public RestaurantAgent getAgent(String phone) {
        List<Restaurant> restaurants = 
        ...
        return agentFactory.create(restaurant.getId());
    }
}
